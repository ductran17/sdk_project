...
int main(void)
{
  ...
  xTaskCreate(CellularDemoTask,    /* Function that implements the task. */
              ...
              (unsigned short)60,  /* Size of stack (in words, not bytes) to allocate for the task. */
              NULL,                /* Task parameter - not used in this case. */
              (UBaseType_t)0U + 1, /* Task priority, must be between 0 and configMAX_PRIORITIES - 1. */
